...
async def test_human_interaction():
    ...
    test_items = [
        {
            ...
            "specifications": {"size": "2x1", "color": "black", "material": "woven"},
        }
    ]
    ...
    urgent_reviews = await human_manager.get_pending_reviews(
        priority_filter=Priority.URGENT
    )
...
async def test_escalation():
    ...
    success = await human_manager.escalate_review(
        review.request_id, "Customer called - needs urgent delivery"
    )
