...
def create_sample_order_excel():
    ...
    # Sample order data
    order_data = {
        'Item Code': ['AS-BLK-CTN-01', 'MYN-SLK-THR-02', 'PE-BLU-FRM-03', 'LS-PRM-GLD-04'],
        'Description': [
...
ABC Fashion House''',
    ...
    print("\n\nCOMBINED ORDER SUMMARY")
    print("="*70)
    print(f"Items from attachment: 4")
    print(f"Items from email body: 2")
    print(f"Total unique items: 6")
