...
class ChromaDBClient:
    ...
    async def initialize(self):
        ...
        try:
            ...
            self.order_history_collection = self.client.get_or_create_collection(
                name="order_history", metadata={"hnsw:space": "cosine"}
            )
    ...
    async def update_inventory_item(
        self, tag_code: str, updates: Dict[str, Any]
    ) -> bool:
        ...
        try:
            ...
            self.inventory_collection.update(ids=[doc_id], metadatas=[current_metadata])
