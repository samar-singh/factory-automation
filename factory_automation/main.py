...
from factory_utils.logging_config import get_logger, setup_logging
...
setup_logging(
    ...
    log_file=(
        Path("logs/factory_automation.log")
...
async def startup_event():
    ...
    orchestrator_type = (
        "AI-powered (v2)" if settings.use_ai_orchestrator else "Traditional (v1)"
    )
...
def main():
    ...
    logger.info(
        f"Gradio dashboard available at http://localhost:{settings.app_port}/dashboard"
    )
