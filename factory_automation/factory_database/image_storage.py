...
class ImageStorageManager:
        ...
        try:
            ...
            if result and result.get("ids") and len(result["ids"]) > 0:
                ...
                return {
                    ...
                    "metadata": {k: v for k, v in metadata.items() if k != "image_base64"},
        ...
        try:
            ...
            for i, img_id in enumerate(result.get("ids", [])):
                ...
                images.append({
                    ...
                    "embedding": self._safe_get_embedding(result.get("embeddings"), i)
                })
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            avg_size = total_size / len(sample["metadatas"]) if sample.get("metadatas") else 0
