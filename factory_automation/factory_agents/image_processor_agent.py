...
class ImageProcessorAgent:
    ...
    def _ensure_image_collection(self):
        ...
        try:
            ...
            collections = [c.name for c in self.chromadb_client.client.list_collections()]
...
Return the analysis as a detailed JSON object with all extracted information."""
            ...
            async with httpx.AsyncClient() as client:
                ...
                if response.status_code == 200:
                    ...
                    logger.error(f"Qwen2.5VL API error: {response.status_code} - {response.text}")
    ...
    async def process_and_store_image(
        ...
        try:
            ...
            collection = self.chromadb_client.client.get_collection(self.image_collection_name)
            ...
            metadata = {
                ...
                "base64_image": base64_image[:100] + "...",  # Store truncated for reference
    ...
    def _create_searchable_text(self, analysis: Dict[str, Any], customer_name: str) -> str:
