...
class HumanReviewInterface:
    ...
    def create_interface(self) -> gr.Blocks:
        ...
        with gr.Blocks(
            ...
            gr.Markdown(
                "Review and approve orders that need manual intervention (60-80% confidence)"
            )
            ...
            with gr.Tabs():
                ...
                with gr.TabItem("✏️ Current Review"):
                    with gr.Row():
                        ...
                        with gr.Column(scale=2):
                            ...
                            search_results = gr.JSON(
                                label="Matched Items from Inventory"
                            )
                    ...
                    with gr.Row():
                        ...
                        skip_review_btn = gr.Button(
                            "⏭️ Skip to Next", variant="secondary"
                        )
            ...
            export_btn.click(
                fn=self.export_data, inputs=[], outputs=[gr.File(label="Exported Data")]
            )
    ...
    def open_review(self, review_id: str):
        ...
        try:
            ...
            logger.info(
                f"Review search_results type: {type(review.search_results)}, content: {review.search_results}"
            )
        ...
        results_display = (
            ...
            else [{"message": "No search results"}]
        )
    ...
    def skip_to_next(self):
        ...
        reviews = asyncio.run(self.interaction_manager.get_pending_reviews())
